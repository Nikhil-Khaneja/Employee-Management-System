import employeemanagement.MySqlConnect;
...
public class EmployeeDetails extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jComboBox2.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "BTech", "MBA", "CA", "CS", "BCOM", "BBA", "BBI", "BMS", " ", " " }));
    ...
    private void btnsaveActionPerformed(java.awt.event.ActionEvent evt) {                                        
        ...
        try {
            ...
            preparedStatement.setString(6, jComboBox2.getSelectedItem().toString());
            
            SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd");
            String strDate = sdf.format(jDateChooser1.getDate());
